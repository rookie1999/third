...
def main():
    """主函数"""
    # 轨迹文件路径
    trajectory_file = "/home/lumos/data_collection_11.14/data_collector_opt/session_20251215_183845/Merged_Trajectory/merged_trajectory.txt"
    ...
    print("初始化机械臂...")
    try:
        arm = SingleArm(can_interface_="can1", gripper=True, enable_fd_=False)
        print("机械臂初始化成功")
        # try:
