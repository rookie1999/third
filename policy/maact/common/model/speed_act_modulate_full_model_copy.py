    ...
    def __init__(self, config: SpeedACTConfig):
        ...
        if self.config.use_vae:
            ...
            if self.config.image_features:
                ...
                dummy_img_shape_h = self.config.image_features[self.config.main_camera].shape[-2]
                dummy_img_shape_w = self.config.image_features[self.config.main_camera].shape[-1]
